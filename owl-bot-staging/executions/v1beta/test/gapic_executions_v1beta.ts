...
describe('v1beta.ExecutionsClient', () => {
    ...
    describe('createExecution', () => {
        it('invokes createExecution without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.workflows.executions.v1beta.CreateExecutionRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.workflows.executions.v1beta.Execution());
    ...
    describe('getExecution', () => {
        it('invokes getExecution without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.workflows.executions.v1beta.GetExecutionRequest());
            request.name = '';
    ...
    describe('cancelExecution', () => {
        it('invokes cancelExecution without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.workflows.executions.v1beta.CancelExecutionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.cancelExecution as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listExecutions', () => {
        it('invokes listExecutions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.workflows.executions.v1beta.ListExecutionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
